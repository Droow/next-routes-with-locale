  ...
  (0, _createClass2["default"])(Routes, [{
    ...
    value: function match(url) {
      ...
      return (0, _reduce["default"])(_context3 = this.routes).call(_context3, function (result, route) {
        ...
        (0, _forEach["default"])(_context4 = (0, _keys["default"])(params)).call(_context4, function (key) {
    ...
    value: function getRequestHandler(app, customHandler) {
      ...
      return function (req, res) {
        ...
        if (route) {
          ...
          parsedUrl.query = _objectSpread({}, query);
    ...
    value: function getLink(Link) {
      ...
      return function (props) {
        ...
        if ((0, _indexOf["default"])(href).call(href, '//') !== -1 || href[0] === '/' || href[0] === '#') {
          ...
          if (Link.propTypes) {
            var allowedKeys = (0, _keys["default"])(Link.propTypes);
...
var Route = /*#__PURE__*/function () {
  function Route(_ref2) {
    ...
    this.keyNames = (0, _map["default"])(_context5 = (0, _keys2["default"])(this)).call(_context5, function (key) {
      return key.name;
    });
  ...
  (0, _createClass2["default"])(Route, [{
    ...
    value: function valuesToParams(values) {
      ...
      return (0, _reduce["default"])(values).call(values, function (params, val, i) {
        return (0, _assign["default"])(params, (0, _defineProperty2["default"])({}, (0, _keys2["default"])(_this5)[i].name, val));
      }, {});
    }
  }, {
    key: "getHref",
...
var toQuerystring = function toQuerystring(obj) {
  ...
  return (0, _map["default"])(_context9 = (0, _keys["default"])(obj)).call(_context9, function (key) {
    var value = obj[key];
